...
#Begin encoder pins
set_property -dict { PACKAGE_PIN V8  IOSTANDARD LVCMOS33 } [get_ports { encoder_a_0[0] }]  ;# JB Pin1
set_property -dict { PACKAGE_PIN W8  IOSTANDARD LVCMOS33 } [get_ports { encoder_b_0[0] }]  ;# JB Pin2
set_property -dict { PACKAGE_PIN U7  IOSTANDARD LVCMOS33 } [get_ports { encoder_a_0[1] }]  ;# JB Pin3
set_property -dict { PACKAGE_PIN V7  IOSTANDARD LVCMOS33 } [get_ports { encoder_b_0[1] }]  ;# JB Pin4
set_property -dict { PACKAGE_PIN Y7  IOSTANDARD LVCMOS33 } [get_ports { encoder_a_0[2] }]  ;# JB Pin7
set_property -dict { PACKAGE_PIN Y6  IOSTANDARD LVCMOS33 } [get_ports { encoder_b_0[2] }]  ;# JB Pin8
set_property -dict { PACKAGE_PIN V6  IOSTANDARD LVCMOS33 } [get_ports { encoder_a_0[3] }]  ;# JB Pin9
set_property -dict { PACKAGE_PIN W6  IOSTANDARD LVCMOS33 } [get_ports { encoder_b_0[3] }]  ;# JB Pin10
                                                                                                                                 
                                                                                                                                 
##Pmod Header JC                                                                                                                  
set_property -dict { PACKAGE_PIN V15 IOSTANDARD LVCMOS33 } [get_ports { encoder_a_0[4] }]  ;# JC Pin1
set_property -dict { PACKAGE_PIN W15 IOSTANDARD LVCMOS33 } [get_ports { encoder_b_0[4] }]  ;# JC Pin2
set_property -dict { PACKAGE_PIN T11 IOSTANDARD LVCMOS33 } [get_ports { encoder_a_0[5] }]  ;# JC Pin3
set_property -dict { PACKAGE_PIN T10 IOSTANDARD LVCMOS33 } [get_ports { encoder_b_0[5] }]  ;# JC Pin4
#End of encoders, begin PWM
set_property -dict { PACKAGE_PIN W14 IOSTANDARD LVCMOS33 } [get_ports { pwm_a_0[4] }] ;# JC Pin7
set_property -dict { PACKAGE_PIN Y14 IOSTANDARD LVCMOS33 } [get_ports { pwm_b_0[4] }] ;# JC Pin8
set_property -dict { PACKAGE_PIN T12 IOSTANDARD LVCMOS33 } [get_ports { pwm_a_0[5] }] ;# JC Pin9
set_property -dict { PACKAGE_PIN U12 IOSTANDARD LVCMOS33 } [get_ports { pwm_b_0[5] }] ;# JC Pin10            
                                                                                                                                 
                                                                                                                                 
##Pmod Header JD                                                                                                                  
set_property -dict { PACKAGE_PIN T14 IOSTANDARD LVCMOS33 } [get_ports { pwm_a_0[0] }] ;# JD Pin1
set_property -dict { PACKAGE_PIN T15 IOSTANDARD LVCMOS33 } [get_ports { pwm_b_0[0] }] ;# JD Pin2
set_property -dict { PACKAGE_PIN P14 IOSTANDARD LVCMOS33 } [get_ports { pwm_a_0[1] }] ;# JD Pin3
set_property -dict { PACKAGE_PIN R14 IOSTANDARD LVCMOS33 } [get_ports { pwm_b_0[1] }] ;# JD Pin4
set_property -dict { PACKAGE_PIN U14 IOSTANDARD LVCMOS33 } [get_ports { pwm_a_0[2] }] ;# JD Pin7
set_property -dict { PACKAGE_PIN U15 IOSTANDARD LVCMOS33 } [get_ports { pwm_b_0[2] }] ;# JD Pin8
set_property -dict { PACKAGE_PIN V17 IOSTANDARD LVCMOS33 } [get_ports { pwm_a_0[3] }] ;# JD Pin9
set_property -dict { PACKAGE_PIN V18 IOSTANDARD LVCMOS33 } [get_ports { pwm_b_0[3] }] ;# JD Pin10
