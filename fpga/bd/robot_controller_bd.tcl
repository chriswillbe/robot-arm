...
################################################################
# This is a generated script based on design: robot_controller
#
...
# source robot_controller_script.tcl
...
set design_name robot_controller
...
user.org:user:multi_axis_motion_control:2.0\
"
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set encoder_a_0 [ create_bd_port -dir I -from 5 -to 0 encoder_a_0 ]
  set encoder_b_0 [ create_bd_port -dir I -from 5 -to 0 encoder_b_0 ]
  set pwm_a_0 [ create_bd_port -dir O -from 5 -to 0 pwm_a_0 ]
  set pwm_b_0 [ create_bd_port -dir O -from 5 -to 0 pwm_b_0 ]
...
\
  ...
  # Create instance: multi_axis_motion_co_0, and set properties
  set multi_axis_motion_co_0 [ create_bd_cell -type ip -vlnv user.org:user:multi_axis_motion_control:2.0 multi_axis_motion_co_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins multi_axis_motion_co_0/s00_axi]
  ...
  connect_bd_net -net encoder_a_0_1  [get_bd_ports encoder_a_0] \
  [get_bd_pins multi_axis_motion_co_0/encoder_a]
  connect_bd_net -net encoder_b_0_1  [get_bd_ports encoder_b_0] \
  [get_bd_pins multi_axis_motion_co_0/encoder_b]
  connect_bd_net -net multi_axis_motion_co_0_pwm_a  [get_bd_pins multi_axis_motion_co_0/pwm_a] \
  [get_bd_ports pwm_a_0]
  connect_bd_net -net multi_axis_motion_co_0_pwm_b  [get_bd_pins multi_axis_motion_co_0/pwm_b] \
  [get_bd_ports pwm_b_0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0  [get_bd_pins processing_system7_0/FCLK_CLK0] \
  [get_bd_pins axi_smc/aclk] \
  [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] \
  [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] \
  [get_bd_pins multi_axis_motion_co_0/s00_axi_aclk]
  ...
  [get_bd_pins multi_axis_motion_co_0/s00_axi_aresetn]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs multi_axis_motion_co_0/s00_axi/reg0] -force
